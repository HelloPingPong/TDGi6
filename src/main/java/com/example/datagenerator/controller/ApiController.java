...
import com.example.datagenerator.dto.*;
import com.example.datagenerator.service.DataGenerationService;
import com.example.datagenerator.service.SchemaService;
...
public class ApiController {
    ...
    public ResponseEntity<String> generateData(@RequestBody GenerationRequest request) {
     ...
     // Endpoint to generate preview data (avoids sending large data for preview)
